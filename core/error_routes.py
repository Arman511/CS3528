...
class routes_error:
    def add_error_routes(app):
        ...
        def error_411():
            ...
            msg = "The server refuses to accept the request without a defined Content-Length."
            return (
                render_template(
                    "error_page.html",
                    user_type=get_user_type(),
        ...
        def handle_request_uri_too_large(e):
        ...
        def handle_request_header_fields_too_large(e):
        ...
        def handle_unavailable_for_legal_reasons(e):
        ...
        def handle_http_version_not_supported(e):
